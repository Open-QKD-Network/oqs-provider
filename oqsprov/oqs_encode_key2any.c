...
# define kyber512_oqkd_evp_type     0
# define kyber512_oqkd_input_type    "kyber512_oqkd"
# define kyber512_oqkd_pem_type      "kyber512_oqkd"

# define p256_kyber512_oqkd_evp_type     0
# define p256_kyber512_oqkd_input_type    "p256_kyber512_oqkd"
# define p256_kyber512_oqkd_pem_type      "p256_kyber512_oqkd"
...
MAKE_ENCODER(, kyber512_oqkd, oqsx, EncryptedPrivateKeyInfo, der);
MAKE_ENCODER(, kyber512_oqkd, oqsx, EncryptedPrivateKeyInfo, pem);
MAKE_ENCODER(, kyber512_oqkd, oqsx, PrivateKeyInfo, der);
MAKE_ENCODER(, kyber512_oqkd, oqsx, PrivateKeyInfo, pem);
MAKE_ENCODER(, kyber512_oqkd, oqsx, SubjectPublicKeyInfo, der);
MAKE_ENCODER(, kyber512_oqkd, oqsx, SubjectPublicKeyInfo, pem);
MAKE_TEXT_ENCODER(, kyber512_oqkd);

MAKE_ENCODER(_ecp, p256_kyber512_oqkd, oqsx, EncryptedPrivateKeyInfo, der);
MAKE_ENCODER(_ecp, p256_kyber512_oqkd, oqsx, EncryptedPrivateKeyInfo, pem);
MAKE_ENCODER(_ecp, p256_kyber512_oqkd, oqsx, PrivateKeyInfo, der);
MAKE_ENCODER(_ecp, p256_kyber512_oqkd, oqsx, PrivateKeyInfo, pem);
MAKE_ENCODER(_ecp, p256_kyber512_oqkd, oqsx, SubjectPublicKeyInfo, der);
MAKE_ENCODER(_ecp, p256_kyber512_oqkd, oqsx, SubjectPublicKeyInfo, pem);
MAKE_TEXT_ENCODER(_ecp, p256_kyber512_oqkd);
