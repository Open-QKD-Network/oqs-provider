...
MAKE_DECODER(, "kyber512_oqkd", kyber512_oqkd, oqsx, PrivateKeyInfo);
MAKE_DECODER(, "kyber512_oqkd", kyber512_oqkd, oqsx, SubjectPublicKeyInfo);

MAKE_DECODER(_ecp, "p256_kyber512_oqkd", p256_kyber512_oqkd, oqsx, PrivateKeyInfo);
MAKE_DECODER(_ecp, "p256_kyber512_oqkd", p256_kyber512_oqkd, oqsx, SubjectPublicKeyInfo);
