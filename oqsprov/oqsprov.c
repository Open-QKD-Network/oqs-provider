...
"1.3.9999.99.46", "kyber512_oqkd",
"1.3.9999.99.45", "p256_kyber512_oqkd",
...
if ((envval = getenv("OQS_OID_KYBER512_OQKD"))) oqs_oid_alg_list[106] = envval;

if ((envval = getenv("OQS_OID_P256_KYBER512_OQKD"))) oqs_oid_alg_list[108] = envval;
...
#endif
#ifdef OQS_ENABLE_KEM_kyber_512
    KEMBASEALG(kyber512_oqkd, 128)
    KEMHYBALG(p256_kyber512_oqkd, 128)
#endif
// clang-format on
...
#endif
#ifdef OQS_ENABLE_KEM_kyber_512
    KEMKMALG(kyber512_oqkd, 128)

    KEMKMHYBALG(p256_kyber512_oqkd, 128, ecp)
#endif
// clang-format on
