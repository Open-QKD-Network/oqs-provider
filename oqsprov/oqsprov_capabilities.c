...
static OQS_GROUP_CONSTANTS oqs_group_list[] = {
   ...
   { 0x029A, 128, TLS1_3_VERSION, 0, -1, -1, 1 },

   { 0x2F9A, 128, TLS1_3_VERSION, 0, -1, -1, 1 },
...
#endif
#ifdef OQS_ENABLE_KEM_kyber_512
    OQS_GROUP_ENTRY(kyber512_oqkd, kyber512_oqkd, kyber512_oqkd, 53),

    OQS_GROUP_ENTRY(p256_kyber512_oqkd, p256_kyber512_oqkd, p256_kyber512_oqkd, 54),
#endif
...
int oqs_patch_codepoints()
{
   ...
   if (getenv("OQS_CODEPOINT_KYBER512_OQKD")) oqs_group_list[53].group_id = atoi(getenv("OQS_CODEPOINT_KYBER512_OQKD"));
   if (getenv("OQS_CODEPOINT_P256_KYBER512_OQKD")) oqs_group_list[54].group_id = atoi(getenv("OQS_CODEPOINT_P256_KYBER512_OQKD"));
